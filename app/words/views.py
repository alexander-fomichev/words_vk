...
from app.words.schemes import WordSchema, WordListSchema, SettingSchema, WordIsCorrectSchema, SettingListSchema, \
    SettingTitleSchema, PatchSettingSchema, PatchWordSchema, WordIdSchema, WordTitleSchema, SettingIdSchema
...
class WordAddView(AuthRequiredMixin, View):
    @docs(tags=["words"], summary="add word", description="Add new word to dictionary")
...
class SettingGetView(AuthRequiredMixin, View):
    @docs(
        tags=["settings"], summary="get setting", description="return setting by title"
    )
...
class SettingPatchView(AuthRequiredMixin, View):
    @docs(
        tags=["settings"], summary="patch setting", description="partial update setting by title"
    )
...
class SettingDeleteView(AuthRequiredMixin, View):
    @docs(tags=["settings"], summary="delete word", description="Delete existed word")
...
class SettingListView(AuthRequiredMixin, View):
    @docs(
        tags=["settings"], summary="get settings", description="return list of settings"
    )
