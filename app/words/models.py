...
class SettingModel:
    ...
    title: str = field(metadata={"sa": Column(String, nullable=False, unique=True)})
    timeout: int = field(metadata={"sa": Column(Integer, nullable=False, )})
    id: Optional[int] = field(default=None, metadata={"sa": Column(Integer, primary_key=True)})
...
class GameModel:
    ...
    moves_order: Optional[str] = field(metadata={"sa": Column(String, nullable=True, )})
    current_move: Optional[int] = field(metadata={"sa": Column(Integer, default=0)})
    event_timestamp: Optional[datetime] = field(metadata={"sa": Column(DateTime(timezone=False), nullable=True, )})
    pause_timestamp: Optional[datetime] = field(metadata={"sa": Column(DateTime(timezone=False), nullable=True, )})
    ...
    peer_id: int = field(metadata={"sa": Column(Integer, nullable=False, )})
    players: List[PlayerModel] = field(
        default_factory=list,
        metadata={"sa": relationship("PlayerModel", cascade="all, delete-orphan",
